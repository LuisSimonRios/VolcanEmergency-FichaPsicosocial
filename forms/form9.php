...
if(isset($_POST["next"])){
  ...
  $query = "INSERT INTO form9 VALUES('', '$tipoIntervencion', '$condicionPrevia', '$atencionPsicosocial', 
      ...
      <div class="content">
        ...
        <div class="tipopoblacion-category">
          ...
          <label for="pSalud">Procedimiento salud</label><b r>
            ...
            <input id="inputother" type="text" placeholder="¿Cuál?" name="atencionPsicosocial onchange="
              changeradioother()">
        </div>
