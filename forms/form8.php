...
if(isset($_POST["next"])){
  ...
  $query = "INSERT INTO form8 VALUES ('', '$nombre1', '$documento1', '$eps1', '$edad1', '$relacion1', 
  '$nombre2', '$documento2', '$eps2', '$edad2', '$relacion2', 
  '$nombre3', '$documento3', '$eps3', '$edad3', '$relacion3', 
  '$nombre4', '$documento4', '$eps4', '$edad4', '$relacion4',
  '$nombre5', '$documento5', '$eps5', '$edad5', '$relacion5',
  '$nombre6', '$documento6', '$eps6', '$edad6', '$relacion6')";
